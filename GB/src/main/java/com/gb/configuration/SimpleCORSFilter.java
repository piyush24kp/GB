package com.margika.configuration;
...
public class SimpleCORSFilter implements Filter {
  ...
  public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws IOException, ServletException {
    ...
    response.setHeader(RestTemplateConstants.AUTHORIZATION.getName(), RestTemplateConstants.AUTHORIZATION.getValue());
    response.setHeader(RestTemplateConstants.ALLOW_CREDENTIALS.getName(), RestTemplateConstants.ALLOW_CREDENTIALS.getValue());
    response.setHeader(RestTemplateConstants.ALLOW_CREDENTIALS.getName(), RestTemplateConstants.ALLOW_CREDENTIALS.getValue());
    response.setHeader(RestTemplateConstants.X_Frame_Options.getName(), RestTemplateConstants.X_Frame_Options.getValue());
